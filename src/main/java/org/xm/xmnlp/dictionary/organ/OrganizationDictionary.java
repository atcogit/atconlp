...
public class OrganizationDictionary {
    ...
    static {
        ...
        dictionary.load(Xmnlp.Config.OrganizationDictionaryPath);
        logger.info(Xmnlp.Config.OrganizationDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
        transformMatrixDictionary = new TransformMatrixDictionary<NT>(NT.class);
        transformMatrixDictionary.load(Xmnlp.Config.OrganizationDictionaryTrPath);
        // TODO:什么时候有空了升级到双数组吧
