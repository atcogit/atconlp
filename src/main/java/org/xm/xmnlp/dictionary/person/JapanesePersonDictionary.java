...
{
    static String path = Xmnlp.Config.JapanesePersonDictionaryPath;
    ...
    static
    {
        ...
        logger.info("日本人名词典" + Xmnlp.Config.PinyinDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
    }
